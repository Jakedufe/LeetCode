...
public class P871MinimumNumberOfRefuelingStops {
    ...
    class Solution {
        ...
        public int minRefuelStops(int target, int startFuel, int[][] stations) {
            ...
            if (n == 0) return target > startFuel ? -1 : 0;
            int ans = -1;
...
//            PriorityQueue<Station> priorityQueue = new PriorityQueue<>((o1, o2) -> o2.fuel - o1.fuel);
//            for (int i = 0; i < n; i++) {
//                while (curFuel < stations[i][0]) {
//                    if (priorityQueue.isEmpty()) return -1;
//                    curFuel += priorityQueue.poll().fuel;
//                    cnt++;
//                }
//                priorityQueue.offer(new Station(i, stations[i][1]));
//            }
