...
//Java：最多可达成的换楼请求数目
//2020-09-27 15:41:26
public class P5526MaximumNumberOfAchievableTransferRequests {

    @Test
    public void testResult() {
        //TO TEST
        Solution solution = new P5526MaximumNumberOfAchievableTransferRequests().new Solution();
    }
    ...
    class Solution {
        public int maximumRequests(int n, int[][] requests) {
            int res = 0;
            for (int i = (1 << requests.length); i > 0; i--) {
                if ((1 << res) > i) break;
                int count = 0;
                int[] out = new int[n];
