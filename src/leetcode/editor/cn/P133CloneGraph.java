...
// Definition for a Node.
    ...
    class Solution {
        ...
        private Node cloneGraph(Node oldNode, Node newNode) {
            if (newNode == null) {
                newNode = new Node(oldNode.val, new ArrayList<>());
                hashMap.put(newNode.val, newNode);
            }
            for (Node neighbor : oldNode.neighbors) {
                if (!hashMap.containsKey(neighbor.val)) {
                    newNode.neighbors.add(cloneGraph(neighbor, null));
                } else newNode.neighbors.add(hashMap.get(neighbor.val));
            }
            return newNode;
        }
    }
